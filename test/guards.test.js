...
import { GAMES_2627_PRESEASON } from './fixtures/preseason-2627.js'
...
describe('frozen data', () => {
  ...
  // did three times (the playoff race on August 10, the week view on September 5, the
  // leaders trade arrow on September 18, 2026), and here on September 11 when a regional
  // channel appeared, each time because some test still reached a live module, directly
  // or through src/. The frozenData plugin in vite.config.js ends that by resolving every
  // such import to a stand-in. These keep it true.
  ...
  it('is what an import of a live data module actually receives', () => {
    expect(GAMES).toBe(GAMES_2627_PRESEASON)

...
// the day it stops being true it blocks a refresh that did nothing wrong. Every check
// below loops over the rows, so an empty preseason table passes them all vacuously.

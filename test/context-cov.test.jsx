...
describe('services context — restoring from localStorage', () => {
  it('starts empty when the saved value is corrupt', () => {
    localStorage.setItem('nba:services', 'not json')
    render(
      <ServicesProvider>
        <ServicesProbe />
      </ServicesProvider>
  ...
  it('starts empty when the saved value is valid JSON but not an array', () => {
    localStorage.setItem('nba:services', JSON.stringify({ peacock: true }))
    render(
      <ServicesProvider>
        <ServicesProbe />
      </ServicesProvider>
  ...
  it('drops saved keys the catalog no longer defines', () => {
    localStorage.setItem('nba:services', JSON.stringify(['peacock', 'gonesvc']))
    render(
      <ServicesProvider>
        <ServicesProbe />
      </ServicesProvider>

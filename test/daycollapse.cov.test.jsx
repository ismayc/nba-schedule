...
const GAMES = [
  { id: 'a1', tip: daysAgo(2), home: 'NY', away: 'BOS', score: [90, 82], venue: 'V', city: 'C' },
  { id: 'a2', tip: daysAgo(2, 20), home: 'LAL', away: 'GS', score: [77, 70], venue: 'V', city: 'C' },
  { id: 'b1', tip: daysAgo(1), home: 'DAL', away: 'PHX', score: [88, 85], venue: 'V', city: 'C' },
]

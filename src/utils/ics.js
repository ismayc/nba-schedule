...
// A NBA game runs about two hours.
const DURATION = 'PT2H30M'
const PRODID = '-//the-nba-schedule//EN'
...
export function buildIcs(games, { name = 'NBA', now = new Date().toISOString() } = {}) {
  const lines = [
    'BEGIN:VCALENDAR',
    'VERSION:2.0',
    `PRODID:${PRODID}`,
...
export function downloadIcs(games, { filename = 'nba.ics', name } = {}) {

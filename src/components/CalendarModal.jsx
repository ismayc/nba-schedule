...
const PROD = 'https://the-nba-schedule.netlify.app'
      ...
      >
        ...
        <div className="cal-section">
          ...
          <div className="cal-downloads">
            <button
              onClick={() =>
                downloadIcs(games, { filename: `nba-${SEASON}.ics`, name: `NBA ${SEASON}` })
              }
            >
              ...
              <button
                onClick={() =>
                  downloadIcs(filtered, {
                    filename: `nba-${SEASON}-filtered.ics`,
                    name: `NBA ${SEASON}`,
                  })
                }
              >
            ...
            {count > 0 && (
              <button
                onClick={() =>
                  downloadIcs(myGames, {
                    filename: `nba-${SEASON}-my-teams.ics`,
                    name: `NBA ${SEASON} — My Teams`,
                  })
                }
              >

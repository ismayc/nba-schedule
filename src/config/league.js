...
export const LEAGUE = {
  ...
  // Two fields, because an NBA season spans two calendar years: SEASON is the ESPN
  // season id (2027) and SEASON_LABEL is what a reader sees ('2026-27').
  season: SEASON,
  ...
  coreLeaguePath: 'basketball/leagues/nba',
  storageKey: 'nba', // 'nba:theme', 'nba:followed', 'nba:alerts', …
  ...
  ics: {
    durationIso: 'PT2H30M',
    prodId: '-//the-nba-schedule//EN',
    domain: 'the-nba-schedule',
    filenameBase: 'nba',
  },

  // Netlify serves /calendar.ics; GitHub Pages cannot run the function.
  feedHost: 'https://the-nba-schedule.netlify.app',
}
